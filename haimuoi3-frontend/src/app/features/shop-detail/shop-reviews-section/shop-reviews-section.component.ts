...
@Component({
  selector: 'app-shop-reviews-section',
  standalone: true,
  imports: [CommonModule, RatingDisplayComponent, ReviewCardComponent],
  templateUrl: './shop-reviews-section.component.html',
  styleUrl: './shop-reviews-section.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ShopReviewsSectionComponent {
